...
(function (scope) {
  ...
  var KO = {
    ...
    "JikKey · Naver Smart Store": "직키 · 네이버 스마트스토어",
    "Get your own ShieldSigner.": "실물 ShieldSigner를 만나보세요.",
    "Get your own SeedSigner.": "실물 SeedSigner를 만나보세요.",
    "Buy ShieldSigner": "ShieldSigner 구매하기",
    "Buy SeedSigner": "SeedSigner 구매하기",
    ...
    "Running the 3rdIteration smartcard fork of SeedSigner, tag SeSi-0.8.7+ShSi-B12, which adds SeedKeeper and Satochip cards.": "SeedKeeper와 Satochip을 지원하는 3rdIteration의 펌웨어를 실행하고 있어요. 릴리스는 SeSi-0.8.7+ShSi-B12예요.",
    "Applet building is unavailable in this browser. It requires Java, Apache Ant and the DIY tools on a device or computer.": "브라우저에서는 애플릿을 빌드할 수 없어요. Java·Apache Ant·DIY 도구가 설치된 기기나 컴퓨터에서 빌드해 주세요.",
